...
import { CalendarDays, Plus, Zap, Sparkles, ChevronRight } from 'lucide-react';
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                <span className="block text-sm font-black text-slate-900 tracking-tight">Ver Horario</span>
                                <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Vista Día / Semana</span>
                            </div>
                        </div>
                ...
                <motion.div whileHover={{ x: 5 }}>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                <span className="block text-sm font-black text-indigo-600 tracking-tight">Nueva Reserva</span>
                                <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Reservar Pista o Clase</span>
                            </div>
                        </div>
